...
namespace VSA_GameHub.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void DeleteGame(int id)
        {
            ...
            user.All_Games.Remove(game);
            user.Balance = user.Balance + game.Price/2;
        ...
        {
            var user = UserManager.FindById(User.Identity.GetUserId());
            CreditToUser new_relation = new CreditToUser();
            new_relation.userBalance = user.Balance;
        ...
        [HttpPost]
        public ActionResult AddCredit(CreditToUser new_relation)
        {
            var user = dbContext.Users.Find(new_relation.userId);
            user.Balance = user.Balance + new_relation.addedCredit;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Name = model.Name, Surname = model.Surname, Adress = model.Adress, Age = model.Age,
                City = model.City, Country = model.Country, All_Games = new List<Game>(),Balance = 0,
                NumberOfGames = 0};
